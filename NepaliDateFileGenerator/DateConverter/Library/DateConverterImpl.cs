...
namespace DateConverter.Core.Library
{
    ...
    public class DateConverterImpl : dateConverterService
    {
        ConversionStartDateData conversionStartDateData;
        DateFunctions dateFunctions;
        NepaliDateData nepaliDateData;
        public DateConverterImpl(ConversionStartDateData _conversionStartDateData, DateFunctions _dateFunctions,NepaliDateData _nepaliDateData)
        {
        ...
        public NepaliDate ToBS(DateTime gDate, NepaliDate.DateFormats date_format = NepaliDate.DateFormats.yMd)
        {
            gDate = gDate.Date;
